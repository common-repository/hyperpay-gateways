...
const ApplePay = React.memo(props => {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
    Object(_Helpers__WEBPACK_IMPORTED_MODULE_3__["useFetch"])("hyperpay_prepare_checkout").get("").then(res => {
...
const memoizedCanMakePayment = async (data, setting) => {
  ...
  if (key in cache) {
    ...
    fetching = true;
    let res = await Object(_Helpers_js__WEBPACK_IMPORTED_MODULE_5__["useFetch"])("hyperpay_can_make_payment&payment_method=" + setting.name).post("", data);
...
const updateContact = async (props, shippingContact) => {
  return Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["useFetch"])("hyperpay_update_checkout").post("", shippingContact).then(response => Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["paymentResult"])(props, response)).catch(err => Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["raiseError"])(err.response.data));
};
const updateShippingMethod = async (props, shippingMethod, shipping_method) => {
  ...
  return Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["useFetch"])("hyperpay_update_method").post("", data).then(response => Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["paymentResult"])(props, response)).catch(err => Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["raiseError"])(err, err.response));
};
const paymentAuthorized = async (props, shippingMethod, payment, checkoutId) => {
  var _payment$billingConta, _payment$shippingCont;
  const data = {
    _wpnonce: props.settings.nonce,
    checkoutId: checkoutId,
    payment_method: props.settings.name,
  ...
  return Object(_Helpers__WEBPACK_IMPORTED_MODULE_0__["useFetch"])("hyperpay_process_checkout").post('', data).then(res => {
